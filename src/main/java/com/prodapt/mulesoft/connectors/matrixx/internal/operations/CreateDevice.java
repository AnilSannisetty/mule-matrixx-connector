...
public class CreateDevice {
	...
	private static final Logger logger = LoggerFactory.getLogger(CreateDevice.class);
	public static final RestRequestBuilder.QueryParamFormat QUERY_PARAM_FORMAT = RestRequestBuilder.QueryParamFormat.MULTIMAP;

	@DisplayName("Create Device")
	@MediaType(value = "application/json")
	@Summary("Creates a new device with the required features")
	public void createDevice(@Config RestConfiguration rc, @Connection MatrixxConnection connection,
		...
		String resourcePath = "/data/json/device";
