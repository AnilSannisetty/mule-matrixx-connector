...
public class AddUserToSubscription {

	private static final Logger logger = LoggerFactory.getLogger(AddUserToSubscription.class);
	public static final RestRequestBuilder.QueryParamFormat QUERY_PARAM_FORMAT = RestRequestBuilder.QueryParamFormat.MULTIMAP;

	@DisplayName("Add User To Subscription")
	@MediaType(value = "application/json")
	@Summary("Add user to the subscription with the required features")
	public void  addusertosubscription(@Config RestConfiguration rc, @Connection MatrixxConnection connection,
