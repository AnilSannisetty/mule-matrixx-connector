...
public class DeleteDevice {
	...
	private static final Logger logger = LoggerFactory.getLogger(DeleteDevice.class);
	public static final RestRequestBuilder.QueryParamFormat QUERY_PARAM_FORMAT = RestRequestBuilder.QueryParamFormat.MULTIMAP;

	@DisplayName("Delete Device")
	@MediaType(value = "application/json")
	@Summary("Delete an existing device")
	public void deleteDevice(@Config RestConfiguration rc, @Connection MatrixxConnection connection,
		...
		String resourcePath = "/data/json/device/" + deleteParams.getObjectID();
		...
		RestRequestBuilder builder = new RestRequestBuilder(connection.getBaseURL(), resourcePath,
				HttpConstants.Method.DELETE, (RequestParameters) parameters).setQueryParamFormat(QUERY_PARAM_FORMAT)
