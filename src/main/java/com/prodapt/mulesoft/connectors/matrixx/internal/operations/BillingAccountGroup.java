...
public class BillingAccountGroup {
	private static final Logger logger = LoggerFactory.getLogger(BillingAccountGroup.class);
	public static final RestRequestBuilder.QueryParamFormat QUERY_PARAM_FORMAT = RestRequestBuilder.QueryParamFormat.MULTIMAP;

	@DisplayName("Create Billing Account Group")
	@MediaType(value = "application/json")
	@Summary("Billing Account Group")
	public void  billingaccountgroup(@Config RestConfiguration rc, @Connection MatrixxConnection connection,
