...
public class CreateUser {
	...
	@Summary("Creates a new user with the required features")
	public void createBillingAccount(@Config RestConfiguration rc, @Connection MatrixxConnection connection,
		...
		String resourcePath = "/data/json/service/user";
