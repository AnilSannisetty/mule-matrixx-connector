...
public class PurchaseOffer {
	...
	private static final Logger logger = LoggerFactory.getLogger(PurchaseOffer.class);
	public static final RestRequestBuilder.QueryParamFormat QUERY_PARAM_FORMAT = RestRequestBuilder.QueryParamFormat.MULTIMAP;

	@DisplayName("Purchase Offer")
	@MediaType(value = "application/json")
	@Summary(" Create Subscription & Device, Purchase offer &Add sub to BAGroup")
	public void  purchaseOffer(@Config RestConfiguration rc, @Connection MatrixxConnection connection,
